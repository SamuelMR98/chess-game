...
public class PawnMoves extends Movement {
    @Override
    ...
    private void addPassant(int column, int passantColumn, int passantRow,
                            int startRow, int attackRow, ChessBoard board, ChessGame.TeamColor color, HashSet<ChessMove> moves) {
